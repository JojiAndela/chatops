    ...
    return (
      <View style={{flex: 1, backgroundColor: '#fff', marginTop: 20}}>
        ...
        {users ? <FlatList
          ...
          ListEmptyComponent={<Text style={{alignSelf: 'center', color: '#ccc', fontSize: 18, fontWeight: 'bold', marginTop:20}}> No Feeds Currently :( </Text>}
        /> : <Text style={{alignSelf: 'center', color: '#ccc', fontSize: 18, fontWeight: 'bold', marginTop:20}}>No Feeds Currently :(</Text>}
