...
class AllMyGroups extends Component {
// state = {
//       filter: '',
//   }
    ...
    return (
      <View style={{flex: 1, backgroundColor: '#fff', marginTop: 20}}>
        ...
        {users ? <FlatList
          ...
          ListEmptyComponent={<Text style={{alignSelf: 'center', color: '#ccc', fontSize: 18, fontWeight: 'bold', marginTop:20}}> You are not involved in any group :( </Text>}
        /> : <Text style={{alignSelf: 'center', color: '#ccc', fontSize: 18, fontWeight: 'bold', marginTop:20}}>You are not involved in any group :(</Text>}
...
export default connect(mapStateToProps)(AllMyGroups);